...
public class MyRecyclerViewAdapter extends RecyclerView
    ...
    private ArrayList<ComplaintObject> mDataset;
    ...
    public static class DataObjectHolder extends RecyclerView.ViewHolder
        ...
        public DataObjectHolder(View itemView) {
            super(itemView);
            label = (TextView) itemView.findViewById(R.id.card1);
            dateTime = (TextView) itemView.findViewById(R.id.card2);
    ...
    public MyRecyclerViewAdapter(ArrayList<ComplaintObject> myDataset) {
        mDataset = myDataset;
    }
